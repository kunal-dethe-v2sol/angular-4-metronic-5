export class LandingHelperService {
    ...
    static handleFormSwitch() {
        $('#m_login_forget_password').click(function (e) {
            e.preventDefault();
            LandingHelperService.displayForgetPasswordForm();
        });

        $('#m_login_forget_password_cancel').click(function (e) {
            e.preventDefault();
            LandingHelperService.displaySignInForm();
        });

        $('#m_login_signup').click(function (e) {
            e.preventDefault();
            LandingHelperService.displaySignUpForm();
        });
    ...
    static init() {
        LandingHelperService.handleFormSwitch();
    }
}